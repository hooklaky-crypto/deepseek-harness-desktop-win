...
export const zh = {
  ...
  'panel.hint': '常用插件控制台在左侧栏底部“插件”面板中',
  'panel.plugins.aria': '插件列表',
  'panel.approvals.aria': '插件审批',
  'panel.trigger': '插件',
...
export const en = {
  ...
  'panel.hint': 'Common plugin controls live in the Plugins panel above Settings',
  'panel.plugins.aria': 'Plugin list',
  'panel.approvals.aria': 'Plugin approvals',
